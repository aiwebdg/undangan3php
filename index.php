...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center">
                    <p class="font-one fs-2 color-one">Pria & Wanita</p>
...
?>
                    ...
                    <a class="btn btn-default font-two fw-bold" href="undangan.html" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="18    " height="18    " fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
    ...
    <section>
        ...
        <script>
            ...
            var uwu = document.getElementById("badan");
            var count = 0;
